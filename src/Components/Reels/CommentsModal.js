...
const CommentsModal = ({ postId, show, onClose }) => {
  ...
  /* sorted chronologically reversed for display */
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <strong style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.75)' }}>
                        {name}
                      </strong>
                      <span
                        style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.28)', flexShrink: 0, marginLeft: 8 }}
                      >
