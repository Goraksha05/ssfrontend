 ...
 *
 * A glowing "Theme" effect button that opens a beautiful palette + mode picker.
 * Drop this into WelcomPage.js (or anywhere).
 *
 * Usage:
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .tpp-trigger:hover { transform:scale(1.06) translateY(-1px) !important; }
        .tpp-apply:hover   { transform:scale(1.02) !important; box-shadow:0 8px 24px var(--accent-glow) !important; }
      ...
      >
        ...
        <span style={{
          ...
          animation: open ? 'tpp-spin-slow 4s linear infinite' : 'none',
          pointerEvents: 'none',
        }} />
      </button>
      ...
      {open && (
        <div style={S.overlay} onClick={() => setOpen(false)}>
          <div
            style={{
              ...S.modal(previewTok),
              background: previewTok.bgCard,
              boxShadow: `0 24px 72px rgba(0,0,0,0.45), 0 0 0 1px ${previewTok.border}`,
            }}
          ...
          >
            ...
            <p style={S.modalSub(previewTok)}>Pick a palette and mode — preview updates live!</p>
              ...
              {Object.entries(PALETTES).map(([key, pal]) => {
                ...
                return (
                  <button
                    ...
                    style={S.paletteCard(previewTok, active, pal)}
                  ...
                  >
                    ...
                    <span style={S.paletteName(previewTok, active)}>{pal.label}</span>
                  </button>
                );
              })}
            </div>
